    ...
    return (
        <div
            className={cn(
                ...
                "[--fade-stop:#141414] dark:[--fade-stop:#141414]",
                className
            )}
            style={{
                perspective: "2000px",
            ...
            >
                ...
                {mounted &&
                    tiles.map((_, i) => (
                        <div
                            key={i}
                            className="tile min-h-[1px] min-w-[1px] border border-white/[0.07] bg-transparent hover:bg-primary/40 hover:border-primary/60 transition-colors duration-[1200ms] hover:duration-0"
                        />
                    ))}
            </div>
